                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-8">
                            <div className="space-y-2">
                                <span className="text-xs font-black text-cyan-500 uppercase tracking-[0.4em]">NASDAQ: DGXX</span>
                            ...
                            <div className="grid grid-cols-2 gap-4 lg:gap-8 pt-4">
                                <div className="p-6 bg-white border border-slate-100 shadow-sm rounded-2xl group hover:border-cyan-500/30 transition-all">
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">52-Week High</p>
                                    <p className="text-2xl font-black text-slate-900">$6.78</p>
                                </div>
                                <div className="p-6 bg-white border border-slate-100 shadow-sm rounded-2xl group hover:border-cyan-500/30 transition-all">
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">52-Week Low</p>
                                    <p className="text-2xl font-black text-slate-900">$0.85</p>
                                </div>
                                <div className="p-6 bg-white border border-slate-100 shadow-sm rounded-2xl group hover:border-cyan-500/30 transition-all">
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Avg 52-Week</p>
                                    <p className="text-2xl font-black text-slate-900">$2.55</p>
                                </div>
                                <div className="p-6 bg-white border border-slate-100 shadow-sm rounded-2xl group hover:border-cyan-500/30 transition-all">
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Market Sector</p>
                                    <p className="text-sm font-black text-slate-900 uppercase">Technology</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-900 p-10 rounded-[3rem] shadow-2xl relative overflow-hidden group border border-white/5">
                            ...
                            <div className="flex justify-between items-start mb-12 relative z-10">
                                <div className="space-y-1">
                                    <h4 className="text-4xl font-black text-white tracking-tighter">$2.66</h4>
                                    <span className="text-xs font-bold text-emerald-400 flex items-center gap-1">
                                        <TrendingUp className="w-3.5 h-3.5" /> +0.11 (4.32%) Today
                                    </span>
                                </div>
                            ...
                            <div className="flex justify-between items-center text-[9px] font-black text-slate-500 uppercase tracking-widest mt-8 border-t border-white/5 pt-6">
                                <span>Vol: 1.2M</span>
                                <span>PE Ratio: 14.2</span>
                                <span>Div Yield: 0.0%</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-slate-950 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col lg:flex-row justify-between items-end mb-16 gap-8">
                        ...
                        <a href="/press-release" className="text-xs font-black text-cyan-500 uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2">
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="relative">
                        <div className="aspect-video bg-slate-900 rounded-[2rem] overflow-hidden group shadow-2xl relative">
                            <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=2070" className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000" />
